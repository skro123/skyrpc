...
int main(int argc, char** argv) {
    ...
    skyrpc::Address::ptr address = skyrpc::IPv4Address::Create("127.0.0.1",port);
    skyrpc::Address::ptr registry = skyrpc::Address::LookupAny("127.0.0.1:8070");
    skyrpc::rpc::RpcServer::ptr server(new skyrpc::rpc::RpcServer());
    std::string str = "lambda";
    //skyrpc::Address::ptr address = skyrpc::Address::LookupAny("127.0.0.1:8081");
