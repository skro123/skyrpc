#ifndef SKYRPC_IO_MANAGER_H
#define SKYRPC_IO_MANAGER_H
#include <atomic>
#include <memory>
#include "scheduler.h"
#include "sync.h"
...
#define go (*skyrpc::IOManager::GetThis()) +
#define Go  (*skyrpc::IOManager::GetThis()) + [=]()mutable
}
#endif //SKYRPC_IO_MANAGER_H
