#ifndef SKYRPC_RPC_SERVER_H
#define SKYRPC_RPC_SERVER_H
#include <functional>
#include <memory>
...
protected:
    ...
    void proxy(F fun, Serializer serializer, const std::string& arg) {
        ...
        try {
            ...
            Result<Return> val;
            val.setCode(skyrpc::rpc::RPC_NO_MATCH);
        ...
        Result<Return> val;
        val.setCode(skyrpc::rpc::RPC_SUCCESS);
        val.setVal(rt);
        serializer << val;
    }
    /**
