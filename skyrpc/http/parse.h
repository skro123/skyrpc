#ifndef SKYRPC_PARSE_H
#define SKYRPC_PARSE_H
#include <memory>
#include "skyrpc/coroutine.h"
#include "http.h"
...
protected:
    ...
    //skyrpc::IOManager* m_mgr = nullptr;
    //skyrpc::Fiber::ptr m_executor;
    //skyrpc::Fiber::ptr m_parser;
    Task<Error> m_parser{};
